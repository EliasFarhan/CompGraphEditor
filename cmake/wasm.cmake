...
function(compilescript main_folder exe_name)
    ...
    foreach(DATA ${DATA_FILES})
        ...
        add_custom_command(
                ...
                -I${CMAKE_SOURCE_DIR}/core/include -I${CMAKE_BINARY_DIR}/core/ -I${CMAKE_BINARY_DIR}/vcpkg_installed/x64-windows/include -std=c++20 -s STANDALONE_WASM -s ERROR_ON_UNDEFINED_SYMBOLS=0
                DEPENDS ${DATA})
