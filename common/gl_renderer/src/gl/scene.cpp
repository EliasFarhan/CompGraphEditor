...
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadShaders(
    const google::protobuf::RepeatedPtrField<gpr5300::pb::Shader>& shadersPb)
{
    ...
    {
        auto& shaderPb = shadersPb(i);
        shaders_[i].LoadShader(shaderPb);
    }
}

gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadPipelines(
...
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadTextures(const PbRepeatField<pb::Texture>& textures)
{
    const auto texturesSize = textures.size();
    textures_.resize(texturesSize);
    auto& textureManager = gpr5300::SceneManager::GetInstance()->GetTextureManager();
    for (int i = 0; i < texturesSize; i++)
    {
        textures_[i] = textureManager.LoadTexture(scene_.textures(i));
    }
}
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadMaterials(const PbRepeatField<gpr5300::pb::Material>& materials)
{
...
void gpr5300::gl::Scene::Update(float dt)
{
    glCheckError();
...
void gpr5300::gl::Scene::Draw(const pb::DrawCommand& command)
{
...
gpr5300::SceneMaterial gpr5300::gl::Scene::GetMaterial(int materialIndex)
{
    const SceneMaterial material{ &pipelines_[materials_[materialIndex].pipelineIndex], &materials_[materialIndex] };
    return material;
}

void gpr5300::gl::Scene::OnEvent(SDL_Event& event)
{
...
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadModels(const PbRepeatField<std::string>& models)
{
...
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadMeshes(const PbRepeatField<pb::Mesh>& meshes)
{
...
gpr5300::Scene::ImportStatus gpr5300::gl::Scene::LoadFramebuffers(const PbRepeatField<pb::FrameBuffer>& framebuffers)
{
